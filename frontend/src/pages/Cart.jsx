              ...
              {userState.email && (
                <div className="w-full items-start relative">
                  ...
                  >
                    ...
                    <p>
                      <span className="font-medium">Card-Info:</span> 4242 4242
                      4242 4242 - 6/25 - 123
                    </p>
                    <p>
                      <span className="font-medium">cardholder Name:</span> tes
                    </p>
                    <p>
                      <span className="font-medium">Country:</span> Bangaldesh
                    </p>
                  </div>
                </div>
              )}
